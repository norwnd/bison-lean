// Modal popup ported from vanilla
// `mmsettings/components/Popup.tsx`.
//
// Wraps content in the site's `#forms` + `stylish-overflow` backdrop
// plus an `mw-425` inner form, portalled into `document.body`.
// Backdrop clicks close the popup unless disabled.
